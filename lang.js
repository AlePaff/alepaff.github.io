...
let LANG_TRANSLATION = {
    ...
    "about-me": {
        "es": `
        <span id="saludo">Hola <span id="hand-emoji">👋</span>, soy Alejandro</span>, un <strong>apasionado</strong> por básicamente <u>cualquier tema</u>: desde saber las etimologías de las palabras hasta construir cosas de hierro y madera [...] hacer ejercicio, tocar el piano, conocer el porqué de las cosas, ver que hay una técnica para escribir más rápido así que ir de lleno a aprenderla, como puedo comunicarme con el otro, aprender muchos idiomas, ayudar, dar clases, estar con amigos y primos, reir siempre mucho, deprimirme, estresarme, ver porque me siento mal y cambiarlo, siempre practicando la introspección.
        <br><br>  
